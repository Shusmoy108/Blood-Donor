...
class MapSample extends StatefulWidget {
  String mobile;
  MapSample(this.mobile);
  @override
  State<MapSample> createState() => MapSampleState(mobile);
}
...
FloatingActionButton(
        onPressed: ()async {
            ...
            Prediction p = await PlacesAutocomplete.show(
                    ...
                    mode: Mode.overlay,
                    onError: onError,
                    location: center==null?null:Location(userLocation.latitude, userLocation.longitude),
 ...
 Future<Null> displayPrediction(Prediction p) async {
    ...
    Iterable getdata() {
      Iterable _markers = Iterable.generate(10, (index) {
        LatLng latLngMarker = LatLng(userLocation.latitude+sin(.01*index),userLocation.longitude+sin(.01*index) );
